          ...
          <div className='project-article-text'>
            ...
            <div className='project-article-codes'>
              ...
              <div className='project-article-codes-section'>
                <a href="https://github.com/Pabloblockchain24/transcurrin.cl" className='project-article-codes-link'> <FaGithubSquare /> FRONTEND </a>
                <a href="https://github.com/Pabloblockchain24/serverTranscurrin" className='project-article-codes-link'> <FaGithubSquare /> BACKEND </a>
              </div>
            </div>
          </div>
