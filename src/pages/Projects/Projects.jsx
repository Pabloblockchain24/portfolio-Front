  ...
  return (
    <section className="projects" id="projects">
      ...
      <h2 className="project-subtitle">
        "Transformar ideas en código es un arte."
      </h2>
      ...
      <article className="project-article">
        <div className="project-article-text">
          ...
          <p className="project-article-description">
            Proyecto front-end desarrollado con react para el curso de
            especialización frontend de corfo con adalid. Cuenta con un
            administrador para gestionar staff y horas medicas y una interfaz
          ...
          <div className="project-article-techs">
            <img
              src={reactLogo}
              alt="react Logo"
              className="project-article-techs-logo"
            />
            <img
              src={htmlLogo}
              alt="html Logo"
          ...
          <div className="project-article-codes">
            ...
            <div className="project-article-codes-section">
              ...
              >
                {" "}
                <FaGithubSquare />{" "}
                <p className="project-article-codes-link-p">BACKEND</p>{" "}
              </a>
            </div>
          </div>
        </div>
        <div className="project-article-iframe">
          <iframe
            src="https://ejercicio2-modulo6-adalid-corfo.vercel.app/"
            width="300"
            height="200"
            frameborder="0"
            scrolling="no"
          ></iframe>
          <a
            href="https://ejercicio2-modulo6-adalid-corfo.vercel.app/"
            class="project-article-iframe-enlace"
          >
            VER SITIO
          </a>
        </div>
        ...
        <article className="project-article">
          <div className="project-article-text">
            <h2 className="project-article-title">TRANSCURRIN.CL</h2>
            <p className="project-article-description">
              Proyecto full-stack con MERN y deploy en Vercel. Cuenta con una
              aplicacion web comercial y una intranet para clientes.
            </p>
            <div className="project-article-techs">
              <img
                src={mongoLogo}
        ...
        <article className="project-article">
          <div className="project-article-text">
            ...
            <p className="project-article-description">
              E-commerce full stack desarrollado con MERN. La aplicación permite
              a usuarios revisar productos, realizar proceso de compra y recibir
              voucher de la compra
            </p>
            <div className="project-article-techs">
              <img
                src={mongoLogo}
            ...
            <div className="project-article-codes">
              ...
              <div className="project-article-codes-section">
                <a
                  href="https://github.com/Pabloblockchain24/bobo.cl-front"
                  className="project-article-codes-link"
                >
                  {" "}
                  <FaGithubSquare />{" "}
                ...
                <a
                  href="https://github.com/Pabloblockchain24/bobo.cl-back"
                  className="project-article-codes-link"
                >
                  {" "}
                  <FaGithubSquare />{" "}
          ...
          <div className="project-article-iframe">
            <iframe
              src="https://bobo-cl-front.vercel.app/"
              width="300"
              height="200"
              frameborder="0"
              scrolling="no"
            ></iframe>
            <a
              href="https://bobo-cl-front.vercel.app/"
              class="project-article-iframe-enlace"
            >
              VER SITIO
            </a>
